...
class TestCaseConvEndian(unittest.TestCase):
    ...
    def test6(self):
        expected = '-A2 91 0E'
        self.assertEqual(expected, conv_endian(num=-954786, endian='little'), self.message)

    def test7(self):
        expected = None
        self.assertEqual(expected, conv_endian(num=-954786, endian='small'), self.message)

    def test8(self):
        expected = '00'
        self.assertEqual(expected, conv_endian(num=0, endian='big'), self.message)
